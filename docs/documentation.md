...
##### Accounting Summary
  ...
  * queue names, along with running/queued jobs info for every queue
  ...
  ![Accounting Summary](https://github.com/qtop/qtop/images/accounting_summary.png "Accounting Summary")
...
![worker nodes occupancy](https://github.com/qtop/qtop/images/wn_occupancy.png "Worker Nodes occupancy")

The default elements displayed are:

###### Worker node ID (virtual or real node name)
  ![worker nodes ID](https://github.com/qtop/qtop/images/wnid.png "Worker Nodes ID")
...
###### Node state
  ![Node state](https://github.com/qtop/qtop/images/node_state.png "Node state")
...
###### Queue names
  ![Queue name](https://github.com/qtop/qtop/images/queue_name.png "Queue name")
...
###### Job allocation table
  ![Cores](https://github.com/qtop/qtop/images/cores.png "Cores")
