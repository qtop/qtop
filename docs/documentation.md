...
##### Accounting Summary
  ...
  * queue names, along with running/queued jobs info for every queue
  ...
  ![Accounting Summary](file:///C:\\Users\\sfranky\\Dropbox\\python\\qtop\\accounting_summary.png "Accounting Summary")
...
![worker nodes occupancy](file:///C:\\Users\\sfranky\\Dropbox\\python\\qtop\\wn_occupancy.png "Worker Nodes occupancy")

The default elements displayed are:

###### Worker node ID (virtual or real node name)
  ![worker nodes ID](file:///C:\\Users\\sfranky\\Dropbox\\python\\qtop\\wnid.png "Worker Nodes ID")
...
###### Node state
  ![Node state](file:///C:\\Users\\sfranky\\Dropbox\\python\\qtop\\node_state.png "Node state")
...
###### Queue names
  ![Queue name](file:///C:\\Users\\sfranky\\Dropbox\\python\\qtop\\queue_name.png "Queue name")
...
###### Job allocation table
  ![Cores](file:///C:\\Users\\sfranky\\Dropbox\\python\\qtop\\cores.png "Cores")
