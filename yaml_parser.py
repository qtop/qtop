...
def get_line(fin, verbatim=False):
    """
    ...
    for line in fin:
        ...
        if indent - prev_indent > 0:
            ...
            d_indent = -1
        line = line.rstrip()
        yield verbatim and [d_indent, line] or [d_indent] + line.split(None, 1)
...
#         line = next(get_lines)
#         # raw_key_values[line[1]] = line[2]
#         # while line[0] >= 0 and len(line) > 1:]
#         while line:
#             block = dict()
...
#             container = process_line(line, fin, get_lines, parent_container, container_stack, stack)
#             # if not container_stack and not stack:
#             #     container_stack.append(parent_container)
